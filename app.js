	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$PhotoGroove$viewSizeChooser($author$project$PhotoGroove$Small),
						$author$project$PhotoGroove$viewSizeChooser($author$project$PhotoGroove$Medium),
						$author$project$PhotoGroove$viewSizeChooser($author$project$PhotoGroove$Large)
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
